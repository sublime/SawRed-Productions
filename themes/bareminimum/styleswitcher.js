...
return null;}
window.onload=function(e){var cookie=readCookie("bareminstyle");var title=cookie?cookie:getPreferredStyleSheet();setActiveStyleSheet(title);}
window.onunload=function(e){var title=getActiveStyleSheet();createCookie("bareminstyle",title,365);}
var cookie=readCookie("bareminstyle");var title=cookie?cookie:getPreferredStyleSheet();setActiveStyleSheet(title);