...
return null;}
window.onload=function(e){var cookie=readCookie("styledotcss");var title=cookie?cookie:getPreferredStyleSheet();setActiveStyleSheet(title);}
window.onunload=function(e){var title=getActiveStyleSheet();createCookie("styledotcss",title,365);}
var cookie=readCookie("styledotcss");var title=cookie?cookie:getPreferredStyleSheet();setActiveStyleSheet(title);